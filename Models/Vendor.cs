...
namespace VendorOnboardingSystem.Models
{
    public class Vendor
    {
        ...
        //any new change
        public bool HasPendingEditRequest { get; set; }

        //++ SECTION 0 — Vendor Auth ++
        ...
        public string VendorType { get; set; } // Goods / Service / Both

        [Required(ErrorMessage = "Vendor Category is required")]
        [Display(Name = "Vendor Category")]
        public string VendorCategory { get; set; } // Domestic / Foreign / Govt / Intercompany
        ...
        public string GSTRegistered { get; set; } // "Yes" or "No"
        ...
        [Display(Name = "GST Certificate Path")]
        ...
        public string MSMERegistered { get; set; } // "Yes" or "No"

        [Display(Name = "Udyam Registration Number")]
        [RegularExpression(@"^UDYAM-[A-Z]{2}-\d{2}-\d{7}$", ErrorMessage = "Invalid Udyam format (UDYAM-XX-00-0000000)")]
        ...
        public string TDSApplicable { get; set; } // "Yes" or "No"

        [Display(Name = "TDS Sections")]
        public string? TDSSections { get; set; } // Comma-separated: "194C,194J,194H"
        ...
        [Display(Name = "Cancelled Cheque Path")]
        ...
        [Display(Name = "Aadhar Copy Path")]
        public string? AadharCopyPath { get; set; }
